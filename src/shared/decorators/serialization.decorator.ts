...
import SerializeInterceptor from 'src/shared/interceptors/serialization.interceptor';
...
const Serialize =
  (type: any) => (proto: any, propName: any, descriptor: any) => {
    setSerializeType(proto[propName], type);
